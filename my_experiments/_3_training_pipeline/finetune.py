...
def init_model():
    ...
    # 加载预训练好的模型权重
    print(f"正在从 {args.base_model_path} 加载预训练权重...")
    state_dict = torch.load(args.base_model_path, map_location=args.device)
...
if __name__ == "__main__":
    ...
    # 基础训练参数
    parser.add_argument("--base_model_path", type=str, required=True, help="预训练好的模型权重路径 (.pth)")
